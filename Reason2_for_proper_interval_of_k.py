...
#_____________________________________________________________________________________________________train3___________________________________________________________________________________________________
    ...
    ancount += 1
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#_____________________________________________________________________________________________find_the_best_k_and_d____________________________________________________________________________________________
plt.figure(1)
plt.plot(compare,accuracy_rate1[0][0])
plt.plot(compare,accuracy_rate2[0][0])
plt.plot(compare,accuracy_rate3[0][0])
plt.title("When d = 50, Accuracy of 3 classifiers changed with the amount of k-mean's cluster centers(same validation set)")
plt.xlabel("Amount of k-mean's cluster centers")
plt.ylabel("Accuracy of validation set")
plt.legend(labels = ['Random Forest', 'SVM', 'Bayes'], loc = 0)
plt.figure(2)
plt.plot(compare,accuracy_rate1[0][1])
plt.plot(compare,accuracy_rate2[0][1])
plt.plot(compare,accuracy_rate3[0][1])
plt.title("When d = 60, Accuracy of 3 classifiers changed with the amount of k-mean's cluster centers(same validation set)")
plt.xlabel("Amount of k-mean's cluster centers")
plt.ylabel("Accuracy of validation set")
plt.legend(labels = ['Random Forest', 'SVM', 'Bayes'], loc = 0)
plt.show()
